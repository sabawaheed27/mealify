...
const LoginForm = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        //.find(...) → searches UserArray for a user that matches username (case-insensitive) and password.
        ...
        } else {        //If match, store the logged-in user in global context and clear inputs.
            setError(null);
            setUser(foundUser);
            setUsername("");
            setPassword("");
